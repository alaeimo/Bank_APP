...
public class DepositInfoForm extends javax.swing.JFrame {

    /**
     * Creates new form DepositInfo
     */
    public DepositInfoForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("نام نوع سپرده");

        jLabel4.setFont(new java.awt.Font("B Roya", 1, 14)); // NOI18N
        jLabel4.setText("سپرده دوم");
       ...
       String deposit = "";
        ...
        try {
            ...
            if(check == true){
                ...
                jLabel11.setText(tokens[3]);
                jLabel12.setText(tokens[4]);
                jLabel13.setText(tokens[5]);
                jLabel14.setText(tokens[6]);
                jLabel15.setText(tokens[7]);
